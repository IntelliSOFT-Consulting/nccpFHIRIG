...
* ^url = "https://nshr-uat.sha.go.ke/fhir/StructureDefinition/nccp-ctcae-adverse-event-observation"
* ^status = #draft
...
* ^url = "https://nshr-uat.sha.go.ke/fhir/StructureDefinition/nccp-oncology-adverse-event"
* ^status = #draft
