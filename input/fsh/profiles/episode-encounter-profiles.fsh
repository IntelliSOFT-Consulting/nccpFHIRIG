...
* ^url = "https://fhir.dha.go.ke/core/StructureDefinition/nccp-oncology-episode-of-care"
* ^status = #draft
...
* ^url = "https://fhir.dha.go.ke/core/StructureDefinition/nccp-oncology-encounter"
* ^status = #draft
