...
* ^url = "https://nshr-uat.sha.go.ke/fhir/StructureDefinition/nccp-oncology-referral-service-request"
* ^status = #draft
...
* ^url = "https://nshr-uat.sha.go.ke/fhir/StructureDefinition/nccp-oncology-coverage-eligibility-request"
* ^status = #draft
...
* ^url = "https://nshr-uat.sha.go.ke/fhir/StructureDefinition/nccp-oncology-claim"
* ^status = #draft
...
* ^url = "https://nshr-uat.sha.go.ke/fhir/StructureDefinition/nccp-oncology-claim-response"
* ^status = #draft
