...
* ^url = "https://fhir.dha.go.ke/core/StructureDefinition/session-id-extension"
* value[x] only string
...
* ^url = "https://fhir.dha.go.ke/core/StructureDefinition/session-number-extension"
...
* ^url = "https://fhir.dha.go.ke/core/StructureDefinition/regimen-reference-extension"
...
* ^url = "https://fhir.dha.go.ke/core/StructureDefinition/treatment-eligibility-extension"
