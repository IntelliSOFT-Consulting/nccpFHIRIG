...
* ^url = "https://fhir.dha.go.ke/nccp/StructureDefinition/carcinoma-staging-extension"
* value[x] only code
...
* ^url = "https://fhir.dha.go.ke/nccp/StructureDefinition/session-expected-date-extension"
* value[x] only date
...
* ^url = "https://fhir.dha.go.ke/nccp/StructureDefinition/sessions-required-extension"
...
* ^url = "https://fhir.dha.go.ke/nccp/StructureDefinition/cost-per-session-extension"
* value[x] only Money
...
* ^url = "https://fhir.dha.go.ke/nccp/StructureDefinition/parent-authorization-extension"
...
* ^url = "https://fhir.dha.go.ke/nccp/StructureDefinition/has-coinsurance-extension"
...
* ^url = "https://fhir.dha.go.ke/nccp/StructureDefinition/coinsurance-details-extension"
* value[x] only string
...
* ^url = "https://fhir.dha.go.ke/nccp/StructureDefinition/comorbidity-extension"
* value[x] only string
...
* ^url = "https://fhir.dha.go.ke/nccp/StructureDefinition/sessions-covered-extension"
* value[x] only integer
...
* ^url = "https://fhir.dha.go.ke/nccp/StructureDefinition/sessions-used-extension"
* value[x] only integer
...
* ^url = "https://fhir.dha.go.ke/nccp/StructureDefinition/start-cycle-extension"
* value[x] only integer
...
* ^url = "https://fhir.dha.go.ke/nccp/StructureDefinition/end-cycle-extension"
* value[x] only integer
