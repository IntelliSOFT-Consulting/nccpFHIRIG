...
* ^url = "https://fhir.dha.go.ke/core/StructureDefinition/ctcae-attribution-extension"
* value[x] only code
...
* ^url = "https://fhir.dha.go.ke/core/StructureDefinition/causative-medication-administration-extension"
...
* ^url = "https://fhir.dha.go.ke/core/StructureDefinition/ctcae-grade-extension"
...
* ^url = "https://fhir.dha.go.ke/core/StructureDefinition/recist-timepoint-extension"
* value[x] only code
...
* ^url = "https://fhir.dha.go.ke/core/StructureDefinition/recist-target-lesion-id-extension"
* value[x] only string
