...
* ^url = "https://fhir.dha.go.ke/core/StructureDefinition/rt-intent-extension"
* value[x] only code
...
* ^url = "https://fhir.dha.go.ke/core/StructureDefinition/rt-total-fractions-extension"
...
* ^url = "https://fhir.dha.go.ke/core/StructureDefinition/rt-dose-per-fraction-extension"
...
* ^url = "https://fhir.dha.go.ke/core/StructureDefinition/rt-treatment-technique-extension"
* value[x] only code
...
* ^url = "https://fhir.dha.go.ke/core/StructureDefinition/rt-beam-type-extension"
* value[x] only code
...
* ^url = "https://fhir.dha.go.ke/core/StructureDefinition/rt-fraction-number-extension"
* value[x] only integer
...
* ^url = "https://fhir.dha.go.ke/core/StructureDefinition/rt-cumulative-dose-extension"
* value[x] only Quantity
...
* ^url = "https://fhir.dha.go.ke/core/StructureDefinition/rt-treatment-machine-extension"
* value[x] only string
