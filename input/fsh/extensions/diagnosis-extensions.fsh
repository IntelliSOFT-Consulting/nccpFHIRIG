...
* ^url = "https://fhir.dha.go.ke/nccp/StructureDefinition/diagnosis-status-extension"
* value[x] only code
...
* ^url = "https://fhir.dha.go.ke/nccp/StructureDefinition/suspicion-level-extension"
* value[x] only code
...
* ^url = "https://fhir.dha.go.ke/nccp/StructureDefinition/reason-for-suspicion-extension"
* value[x] only code
...
* ^url = "https://fhir.dha.go.ke/nccp/StructureDefinition/post-coordinated-code-extension"
* value[x] only string
...
* ^url = "https://fhir.dha.go.ke/nccp/StructureDefinition/metastases-sites-extension"
* value[x] only code
